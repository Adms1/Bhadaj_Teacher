...
public class GetGradeAsyncTask extends AsyncTask<Void, Void, LeaveMainModel> {

        HashMap<String, String> param = new HashMap<String, String>();

        public GetGradeAsyncTask(HashMap<String, String> param) {
            this.param = param;
        }
        ...
        protected LeaveMainModel doInBackground(Void... params) {
            ...
            try {
                responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.GetGrade), param);
                Gson gson = new Gson();
