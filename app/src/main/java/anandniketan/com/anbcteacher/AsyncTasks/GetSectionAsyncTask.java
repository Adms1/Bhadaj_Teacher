...
public class GetSectionAsyncTask extends AsyncTask<Void, Void, LeaveMainModel> {

    HashMap<String, String> param;

    public GetSectionAsyncTask(HashMap<String, String> param) {
        this.param = param;
    }
    ...
    protected LeaveMainModel doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.GetSection), param);
            Gson gson = new Gson();
