...
public class GetSubjectAsyncTask extends AsyncTask<Void, Void, LeaveMainModel> {

    HashMap<String, String> param;

    public GetSubjectAsyncTask(HashMap<String, String> param) {
        this.param = param;
    }
    ...
    protected LeaveMainModel doInBackground(Void... params) {
        ...
        try {
            responseString = WebServicesCall.RunScript(AppConfiguration.getUrl(AppConfiguration.GetSubject), param);
            Gson gson = new Gson();
