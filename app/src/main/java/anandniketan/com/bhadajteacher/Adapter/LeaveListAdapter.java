...
import anandniketan.com.bhadajteacher.Fragment.LeaveFragment;
...
public class LeaveListAdapter extends BaseExpandableListAdapter {
    ...
    private TextView leave_date_txt, approve_day_txt, approve_by_txt, cl_txt, pl_txt, reason_txt;
    private LinearLayout leave_date_linear,edit_delete_linear, approveday_date_linear, approve_by_linear, cl_pl_linear, reason_linear;
